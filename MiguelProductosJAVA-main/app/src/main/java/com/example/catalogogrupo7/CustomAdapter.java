package com.example.catalogogrupo7;
...
import com.example.catalogogrupo7.R;
...
public class CustomAdapter extends ArrayAdapter<Producto> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        builder.build().load("http://proyectojero.eastus.cloudapp.azure.com/"+myData.get(position).getImagen()).into(productoImg);
